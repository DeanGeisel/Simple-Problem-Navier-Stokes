...
xmesh=257; %number of evenly spaced x values to be used in the 
...
eta=0.5 ;%1/Reynold's number /Assume Reynolds number of 200 in this case. 
...
theta=30; %angle of declination measured in degrees
...
for q=1:ymesh
    ...
    Jhold(q,1)=rho*k*(2*UM(q,p)-Ugst)+4*eta;
end
